...
BEGIN
	...
	INSERT INTO StdContrat (IdDevis, IdOldHist, IdIntermediaire, IdProduit, IdCompagnie, IdClient, IdAssure, IdAvenant,
							 ...
							 idpolicepegas,numeropolicecompagnie, primeimposee, primeannuelle, primenette, taxe, fga, accessoire, primettc)
    ...
    SELECT iddevis, id_old_contrat, idintermediaire, idproduit, idcompagnie, idclient, idassure, idavenant,
		   ...
		   numeropoliceconnexe, idpolicepegas, numeropolicecompagnie, primeimposee, primeannuelle, primenette, taxe, fga, accessoire, primettc
    FROM StdDevis
    WHERE iddevis = id_devis
