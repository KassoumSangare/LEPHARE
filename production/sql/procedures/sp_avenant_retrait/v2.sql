-- Correction : sp_avenant_creation_devis_initial attend 9 paramètres depuis migration 0075.
-- Ajout de date_expiration (récupérée depuis le contrat) et motif_annulation (vide pour RET).
...
BEGIN
		...
		SELECT SA.CodeAvenant, SC.flotte, SC.dateexpiration
		INTO code_avenant_ancien, contrat_flotte, date_expiration
		...
		CALL sp_avenant_creation_devis_initial(user_id, id_contrat, id_avenant, date_emission, date_effet, date_expiration, '', id_devis, out_message);
