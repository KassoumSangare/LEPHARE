...
-- 	END IF;
	...
	ELSE
		IF lien_affilie = 'A' AND EXISTS (SELECT * FROM StdAffilie WHERE idadherent = adherent AND iddevis = devis AND idoperateur = user_id AND lien ='A' AND idaffilie <> id_affilie) THEN
